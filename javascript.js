...
(function() {
	...
	var quotes = [
		...
		'To alcohol! The cause of, and solution to, all of life\'s problems<br/>-Homer Simpson from \"The Simpsons\"',
		...
		'If fucking is power, I should be the Hulk by now<br/>-Richard Kadrey',
		...
		'Weddings are basically funerals with cake<br/>-Rick Sanchez from \"Rick and Morty\"',
		...
		'I\'m realizing that some of my greatest (or at least most determined) genius lies in my ability to procrastinate<br/>-Scott Stabile',
		...
		'Just about everything in this world is easier said than done, with the exception of \"systematically assisting Sisyphus\'s stealth, cyst-susceptible,\" which is easier done than said<br/>-Lemony Snicket',
		...
		'My common sense is tingling<br/>-Deadpool',
		...
		'If a mute kid swears, should his mother wash his hands with soap?<br/>-Steven Wright',
		...
		'All my life I\'ve had girls tell me, \"Not if you were the last man on Earth\". Well, that may be true, but let\'s see what happens when I\'m the last man on Earth with a sweet ass, pimped out ride, bitch!<br/>-Tucker from \"Red vs Blue\"',
		...
		'I had a dream about you last night...shortly after I woke up screaming in terror<br/>-Amy Sommers',
		'Fun war fact: there\'s are more crashed planes in the bottom of the ocean than there are crashed submarines in the sky<br/>-Jeremy Dooley from \"On The Spot\"',
		'Why does everyone have to pretend to be stupid and not know long words?<br/>-Martin Freeman',
		'If you were going to shoot a mime, would you use a silencer<br/>-Steven Wright',
		'Whatever my ancestors did to you, none of them consulted me<br/>-Tad Williams',
		'Life is an endless series of trainwrecks with only brief, commercial-like breaks of happiness<br/>-Deadpool',
		'When it comes to being famous, you\'re usually the last to know, and the first to deny it. Unless you were already famous in your head. In which case, party on, Wayne! Party on, Garth!<br/>-Carroll Bryant',
		'What on earth would I do if four bears came into my camp? Why, I would die of course. Literally shit myself lifeless<br/>-Bill Bryson',
		'What\'s a wingding? Why a wingding is, uh...it\'s just like a shindig but without all the hullabaloo<br/>-Cuthbert Soup',
		'The brain can be a dangerous thing. Even more so if you haven\'t got one<br/>-Dave Courtney',
		'If a tie is like kissing your sister, losing is like kissing your grandmother with her teeth out<br/>-George Brett',
		...
		'Home is where, when you go there and tell people to get out, they have to leave<br/>-Jim Butcher',
		'We have normality. I repeat, we have normality. Anything you still can\'t cope with is therefore your own problem<br/>-Douglas Adams',
		'Of all the consumer products, chewing gum is perhaps the most ridiculous: it literally has no nourishment - you just chew it to give yourself something to do with your stupid idiot Western mouth. Half the world is starving, and the other\'s going, \"I don\'t actually need any nutrition, but it would be good to masticate, just to keep my mind off things\"<br/>-Russell Brand',
		'You can\'t make footprints in the sands of time if you\'re sitting on your butt. And who wants to make buttprints in the sands of time?<br/>-Bob Moawad',
		'A boy who once wiped his ass with poison ivy probably doesn\'t belong in a smart people\'s club<br/>-Stephen King',
		'Every intelligent being, whether it breathes or not, coughs nervously at some time in its life<br/>-Terry Pratchett',
		'So if animals aren\'t our friends, then what are they? The answer can be summed between two buns<br/>-Stephen Colbert',
		'I hate patience. Slows everything down<br/>-J.D. Robb',
		'Plans are invitation to disappointment<br/>-Derek Landy',
		'Anything that doesn\'t take years of your life and drive you to suicide hardly seems worth doing<br/>-Cormac McCarthy',
		'It\'s amazing that the amount of news that happens in the world every day always just exactly fits the newspaper<br/>-Jerry Seinfield',
		'I feel a disturbance. If\'s as if an infinite number of people are laughing and pitying me to the best of their abilities at once...and that many more are screaming at me to run very...VERY far away. As time passes, the voices become louder and louder and more urgent...and apparently more vulgar as well...HEY I HEARD THAT YOU ASSHOLE!<br/>-Ghost Oogakari from \"Yet Again With a Little Extra Help\"'
